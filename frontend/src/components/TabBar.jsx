...
function BingoIcon({ active }) {
  const stroke = active ? '#f0d492' : '#5f6f95';
  const fill = active ? 'rgba(240,212,146,0.15)' : 'none';
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
      <rect x="3.5" y="3.5" width="17" height="17" rx="2.5" stroke={stroke} strokeWidth="1.8" fill={fill} />
      <path d="M3.5 9.7h17M3.5 15.3h17M9.3 3.5v17M14.7 3.5v17" stroke={stroke} strokeWidth="1.4" />
      <circle cx="12" cy="12.5" r="1.6" fill={stroke} />
    </svg>
  );
}
