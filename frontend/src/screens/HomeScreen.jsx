    ...
    <div className="home-screen">
      <div className="top-row">
        <div>
          ...
          <p className="name">{user?.first_name || 'Player'}</p>
        </div>
        {onOpenAdmin && (
      ...
      <div className="quick-actions">
        ...
        <ActionButton label="Bingo" onClick={() => onNavigate('bingo')} icon={BingoActionIcon} />
      ...
      <div className="status-card">
        ...
        {!user?.has_deposited && (
          <p className="status-note">
            Make your first deposit to unlock withdrawals and start playing Bingo.
          </p>
        )}
      </div>
...
function BingoActionIcon() {
  return (
    <svg width="17" height="17" viewBox="0 0 24 24" fill="none">
      <rect x="3.5" y="3.5" width="17" height="17" rx="2.5" stroke="#f0d492" strokeWidth="1.8" />
      <path d="M3.5 9.7h17M3.5 15.3h17M9.3 3.5v17M14.7 3.5v17" stroke="#f0d492" strokeWidth="1.2" />
    </svg>
  );
}
