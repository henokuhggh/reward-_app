...
export default function BalanceCard({ balance, signupBonus }) {
  const formatted = Number(balance || 0).toLocaleString('en-US', {
    minimumFractionDigits: 2,
    maximumFractionDigits: 2
  });
  const bonusFormatted = Number(signupBonus || 0).toLocaleString('en-US', {
    minimumFractionDigits: 2,
    maximumFractionDigits: 2
  });
  ...
  return (
    <div className="balance-card">
      ...
      <div className="card-bottom">
        <span className="network-mark">PIKOPAY</span>
      </div>
