 ...
 * Lists ALL campaigns (active and inactive) - unlike the public
 * GET /api/channels, this doesn't filter by claimed/spent, since
 * admins need to see and manage everything.
 */
