...
// Referral links come in two shapes depending on how they were
// generated/shared: /r/CODE (the canonical link the backend builds
// for website users) or ?ref=CODE (a plain query param, e.g. if
// someone hand-builds a link or shares via a platform that strips
// paths). Support both so neither format silently drops the code.
...
export default function AuthScreen({ onAuthed }) {
  const [mode, setMode] = useState(() => (getReferralCodeFromUrl() ? 'register' : 'login'));
